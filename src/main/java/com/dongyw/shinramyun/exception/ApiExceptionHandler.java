...
//    private String discordWebhookUrl;
	...
	public ResponseEntity<ErrorResponse<ApiException>> apiExceptionHandler(ApiException exception) {
	...
	public ResponseEntity<ErrorResponse<T>> allExceptionHandler(RuntimeException exception) {
	...
	public ResponseEntity<ErrorResponse<T>> validExceptionHandler(MethodArgumentNotValidException ex) {
